        ...
        <FadeIn>
          ...
          <div className="cta-flow">
            ...
            <div style={{ position: "relative", display: "inline-block" }}>
              <motion.a href="#contact" className="cta-main-btn" onClick={(e) => { e.preventDefault(); smoothScrollTo("contact"); }} style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "var(--accent)", color: "#fff", padding: "0.92rem 2.2rem", fontFamily: "'Satoshi',sans-serif", fontSize: "0.86rem", fontWeight: 500, textDecoration: "none", borderRadius: "4px" }} whileHover={{ scale: 1.02, y: -1 }} whileTap={{ scale: 0.98 }} transition={{ duration: 0.2 }}>
  Book a Free Call →
</motion.a>
